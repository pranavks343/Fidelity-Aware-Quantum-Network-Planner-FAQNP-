...
from strategy.agent import QuantumNetworkAgent, AgentConfig
from core.executor import GameExecutor, quick_start
...
def example_budget_management():
    ...
    from strategy.strategy import EdgeScore
...
def example_complete_flow():
    ...
    print("""
    from core.executor import quick_start
